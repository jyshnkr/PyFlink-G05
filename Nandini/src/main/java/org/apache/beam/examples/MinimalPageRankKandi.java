...
public class MinimalPageRankKandi {
  ...
  public static void main(String[] args) {
    ...
    // in its dependencies.
      ...
      PCollection<KV<String, String>> pcolKV1 = KandiNandiMapper01(p,"go.md", dataFolder);
      PCollection<KV<String, String>> pcolKV2 = KandiNandiMapper01(p,"java.md", dataFolder);
      PCollection<KV<String, String>> pcolKV3 = KandiNandiMapper01(p,"python.md", dataFolder);
      PCollection<KV<String, String>> pcolKV4 = KandiNandiMapper01(p,"README.md", dataFolder);

      PCollectionList<KV<String , String>> pColList = PCollectionList.of(pcolKV1).and(pcolKV2).and(pcolKV3).and(pcolKV4);
      //Merged PCollection
      ...
      pLinksString.apply(TextIO.write().to("kandiPR"));
      p.run().waitUntilFinish();
  }
  
  public static PCollection<KV<String,String>> KandiNandiMapper01(Pipeline p, String filename, String dataFolder){
...
// Create a PipelineOptions object. This object lets us set various execution
    ...
    // We want to read from a file - just one - we need the file name - assign to a variable.// Create a PipelineOptions object. This object lets us set various execution
    // options for our pipeline, such as the runner you wish to use. This example
    // will run with the DirectRunner by default, based on the class path configured
    // in its dependencies.
    //PipelineOptions options = PipelineOptionsFactory.create();
...
//                 //.via((String linkline) -> linkline.substring(9, 18))
//                 .via((String linkline) -> 
//                 linkline.substring(linkline.indexOf('(')+1,linkline.indexOf(')')))
//           );
